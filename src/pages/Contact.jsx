                ...
                <li className="flex gap-4 mb-4">
                  <div className="w-10 h-10 bg-cyan-100 dark:bg-[hsl(41,98%,75%)] items-center flex justify-center rounded-xl">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="lucide lucide-mail-icon lucide-mail text-cyan-500 dark:text-orange-400"
                    >
                ...
                <li className="flex gap-4 mb-4">
                  <div className="w-10 h-10 bg-cyan-100 dark:bg-[hsl(41,98%,75%)] items-center flex justify-center rounded-xl">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="lucide lucide-phone-icon lucide-phone text-cyan-500 dark:text-orange-400"
                    >
                ...
                <li className="flex gap-4 mb-4">
                  <div className="w-10 h-10 bg-cyan-100 dark:bg-[hsl(41,98%,75%)] items-center flex justify-center rounded-xl">
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="lucide lucide-map-pin-icon lucide-map-pin text-cyan-500 dark:text-orange-400"
                    >
