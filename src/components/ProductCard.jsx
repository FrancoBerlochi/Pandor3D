...
const ProductCard = ({index, img, tittle, size}) => {
  ...
  return (
    <div className="group w-[30vw] h-[75vh] flex flex-col p-4 fadeIn border-2 border-gray-300 rounded-xl hover:border-cyan-500 dark:border-[#111] dark:hover:border-[hsl(41,98%,65%)] transition-colors duration-200 overflow-hidden">
      <img
        src={img}
        alt=""
      ...
      {details && id === index && <ViewDetails></ViewDetails>}
    </div>
  );
}
